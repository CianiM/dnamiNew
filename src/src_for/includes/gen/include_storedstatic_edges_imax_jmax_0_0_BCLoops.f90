...
qst(nx+2+0,ny+2+0,indvarsst(13)) =  ((q(nx+2+0,ny+2+0,indvars(5))/((qst(nx+2+0,ny+2+0,indvarsst(4))+&
                    ...
                    param_float(11 + 5)*((q(nx+2+0,ny+2+0,indvars(5))/((qst(nx+2+0,ny+2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,ny+2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,ny+2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,ny+2+0,indvarsst(2))**2))**6-&
                    (q(nx+2+0,ny+2+0,indvars(5))/((qst(nx+2+0,ny+2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,ny+2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,ny+2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,ny+2+0,indvarsst(2))**2))))*(1+&
                    param_float(12 + 5)**6)/(((q(nx+2+0,ny+2+0,indvars(5))/((qst(nx+2+0,ny+2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,ny+2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,ny+2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,ny+2+0,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(nx+2+0,ny+2+0,indvars(5))/((qst(nx+2+0,ny+2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,ny+2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,ny+2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,ny+2+0,indvarsst(2))**2))**6-&
                    (q(nx+2+0,ny+2+0,indvars(5))/((qst(nx+2+0,ny+2+0,indvarsst(4))+&
