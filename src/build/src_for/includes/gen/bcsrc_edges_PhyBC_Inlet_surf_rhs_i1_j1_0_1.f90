...
subroutine boundaryScheme_edges_PhyBC_Inlet_surf_rhs_i1_j1_0_1(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_rhs_rho_dx_0_1m2p0p01m2p1k,d1_rhs_rho_dx_0_1m2p0p11m2p1k,d1_rhs_rho_dx_0_1m2p0p21m2p1k &
            ,d1_rhs_rho_dx_0_1m2p01m2p1k &
            ,d1_rhs_rho_dx_1_1m2p0p01m2p1k,d1_rhs_rho_dx_1_1m2p0p11m2p1k,d1_rhs_rho_dx_1_1m2p0p21m2p1k &
            ,d1_rhs_rho_dx_1_1m2p01m2p1k &
            ,d1_rhs_rho_dy_0_1m2p01m2p1m1k,d1_rhs_rho_dy_0_1m2p01m2p1p0k,d1_rhs_rho_dy_0_1m2p01m2p1p1k &
...
rhs(1-2+0,1-2+1,indvars(1)) =   -  ( (1.0_wp/(param_float(23 + 5)*(param_float(3 + 5))*q(1-2+0,1-2+1,indvars(1))*((q(1-2+0,1-2+1,indvars(4))-&
                    ...
                    q(1-2+0,1-2+1,indvars(3))*q(1-2+0,1-2+1,indvars(3)))))/q(1-2+0,1-2+1,indvars(1)))**2*(((((param_float(23 + 5)*(param_float(3 + 5))*q(1-2+0,1-2+1,indvars(1))*((q(1-2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(1-2+0,1-2+1,indvars(2))*q(1-2+0,1-2+1,indvars(2))+&
                    q(1-2+0,1-2+1,indvars(3))*q(1-2+0,1-2+1,indvars(3)))))/q(1-2+0,1-2+1,indvars(1)))+&
                    q(1-2+0,1-2+1,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(1-2+0,1-2+1,indvars(1))*((q(1-2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(1-2+0,1-2+1,indvars(2))*q(1-2+0,1-2+1,indvars(2))+&
                    q(1-2+0,1-2+1,indvars(3))*q(1-2+0,1-2+1,indvars(3)))))/q(1-2+0,1-2+1,indvars(1)))*q(1-2+0,1-2+1,indvars(1))*d1_rhs_rho_dx_0_1m2p01m2p1k+&
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_PhyBC_Inlet_surf_rhs_i1_j1_0_1
