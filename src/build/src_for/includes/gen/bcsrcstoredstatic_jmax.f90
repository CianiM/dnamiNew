...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_im1nyp2p0k,d1_stemp_dx_0_ip0nyp2p0k,d1_stemp_dx_0_ip1nyp2p0k &
            ...
            ,d1_detady_dy_0_inyp2p0p0k,d1_detady_dy_0_inyp2p0m1k,d1_detady_dy_0_inyp2p0m2k &
 ...
 real(wp) ::  d1_stemp_dx_0_im1nyp2m1k,d1_stemp_dx_0_ip0nyp2m1k,d1_stemp_dx_0_ip1nyp2m1k &
            ...
            ,d1_detady_dy_0_inyp2m1m1k,d1_detady_dy_0_inyp2m1p0k,d1_detady_dy_0_inyp2m1p1k &
...
qst(i,ny+2+0,indvarsst(14)) =  (q(i,ny+2+0,indvars(5))/((qst(i,ny+2+0,indvarsst(4))+&
...
qst(i,ny+2-1,indvarsst(14)) =  (q(i,ny+2-1,indvars(5))/((qst(i,ny+2-1,indvarsst(4))+&
