...
subroutine boundaryScheme_edges_PhyBC_Inlet_surf_rhs_i1_j1_0_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
rhs(1-2+0,1-2+0,indvars(1)) =   -  ( (1.0_wp/(param_float(23 + 5)*(param_float(3 + 5))*q(1-2+0,1-2+0,indvars(1))*((q(1-2+0,1-2+0,indvars(4))-&
                    ...
                    q(1-2+0,1-2+0,indvars(3))*q(1-2+0,1-2+0,indvars(3)))))/q(1-2+0,1-2+0,indvars(1)))**2*(((((param_float(23 + 5)*(param_float(3 + 5))*q(1-2+0,1-2+0,indvars(1))*((q(1-2+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,1-2+0,indvars(2))*q(1-2+0,1-2+0,indvars(2))+&
                    q(1-2+0,1-2+0,indvars(3))*q(1-2+0,1-2+0,indvars(3)))))/q(1-2+0,1-2+0,indvars(1)))+&
                    q(1-2+0,1-2+0,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(1-2+0,1-2+0,indvars(1))*((q(1-2+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,1-2+0,indvars(2))*q(1-2+0,1-2+0,indvars(2))+&
                    q(1-2+0,1-2+0,indvars(3))*q(1-2+0,1-2+0,indvars(3)))))/q(1-2+0,1-2+0,indvars(1)))*q(1-2+0,1-2+0,indvars(1))*d1_rhs_rho_dx_0_1m2p01m2p0k+&
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_PhyBC_Inlet_surf_rhs_i1_j1_0_0
