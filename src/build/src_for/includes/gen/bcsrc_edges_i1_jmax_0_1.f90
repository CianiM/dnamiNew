...
subroutine boundaryScheme_edges_i1_jmax_0_1(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_conv_rho_dx_0_1m2p0p0nyp2m1k,d1_conv_rho_dx_0_1m2p0p1nyp2m1k,d1_conv_rho_dx_0_1m2p0p2nyp2m1k &
            ...
            ,d2_conv_nut_dxdx_0_0_1m2p0p0nyp2m1k_1m2p0p0p0nyp2m1k,d2_conv_nut_dxdx_0_0_1m2p0p0nyp2m1k_1m2p0p0p1nyp2m1k,d2_conv_nut_dxdx_0_0_1m2p0p0nyp2m1k_1m2p0p0p2nyp2m1k &
            ,d2_conv_nut_dxdx_0_0_1m2p0p0nyp2m1k &
            ,d2_conv_nut_dxdx_0_0_1m2p0p1nyp2m1k_1m2p0p1m1nyp2m1k,d2_conv_nut_dxdx_0_0_1m2p0p1nyp2m1k_1m2p0p1p0nyp2m1k,d2_conv_nut_dxdx_0_0_1m2p0p1nyp2m1k_1m2p0p1p1nyp2m1k &
            ,d2_conv_nut_dxdx_0_0_1m2p0p1nyp2m1k &
            ,d2_conv_nut_dxdx_0_0_1m2p0p2nyp2m1k_1m2p0p2m1nyp2m1k,d2_conv_nut_dxdx_0_0_1m2p0p2nyp2m1k_1m2p0p2p0nyp2m1k,d2_conv_nut_dxdx_0_0_1m2p0p2nyp2m1k_1m2p0p2p1nyp2m1k &
            ...
            ,d2_conv_nut_dydy_0_0_1m2p0nyp2m1m1k_1m2p0nyp2m1m1m1k,d2_conv_nut_dydy_0_0_1m2p0nyp2m1m1k_1m2p0nyp2m1m1p0k,d2_conv_nut_dydy_0_0_1m2p0nyp2m1m1k_1m2p0nyp2m1m1p1k &
            ,d2_conv_nut_dydy_0_0_1m2p0nyp2m1m1k &
            ,d2_conv_nut_dydy_0_0_1m2p0nyp2m1p1k_1m2p0nyp2m1p1p0k,d2_conv_nut_dydy_0_0_1m2p0nyp2m1p1k_1m2p0nyp2m1p1m1k,d2_conv_nut_dydy_0_0_1m2p0nyp2m1p1k_1m2p0nyp2m1p1m2k &
            ,d2_conv_nut_dydy_0_0_1m2p0nyp2m1p1k &
...
rhs(1-2+0,ny+2-1,indvars(5)) = rhs(1-2+0,ny+2-1,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(1-2+0,ny+2-1,indvarsst(10)))**2*(d1_dif_nut_dx_0_1m2p0nyp2m1k)*(d1_dif_nut_dx_1_1m2p0nyp2m1k)+&
                    ...
                    param_float(6 + 5)*(1-&
                    qst(1-2+0,ny+2-1,indvarsst(16)))*qst(1-2+0,ny+2-1,indvarsst(20))*q(1-2+0,ny+2-1,indvars(1))*q(1-2+0,ny+2-1,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*qst(1-2+0,ny+2-1,indvarsst(13))-&
                    param_float(6 + 5)/param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(16)))*q(1-2+0,ny+2-1,indvars(1))*q(1-2+0,ny+2-1,indvars(5))**2/qst(1-2+0,ny+2-1,indvarsst(2))**2 ) 
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_i1_jmax_0_1
