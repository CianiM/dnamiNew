...
subroutine boundaryScheme_faces_jmax_1(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_conv_rho_dx_0_im1nyp2m1k,d1_conv_rho_dx_0_ip0nyp2m1k,d1_conv_rho_dx_0_ip1nyp2m1k &
            ...
            ,d2_conv_nut_dxdx_0_0_im1nyp2m1k_im1m1nyp2m1k,d2_conv_nut_dxdx_0_0_im1nyp2m1k_im1p0nyp2m1k,d2_conv_nut_dxdx_0_0_im1nyp2m1k_im1p1nyp2m1k &
            ,d2_conv_nut_dxdx_0_0_im1nyp2m1k &
            ,d2_conv_nut_dxdx_0_0_ip1nyp2m1k_ip1m1nyp2m1k,d2_conv_nut_dxdx_0_0_ip1nyp2m1k_ip1p0nyp2m1k,d2_conv_nut_dxdx_0_0_ip1nyp2m1k_ip1p1nyp2m1k &
            ...
            ,d2_conv_nut_dydy_0_0_inyp2m1m1k_inyp2m1m1m1k,d2_conv_nut_dydy_0_0_inyp2m1m1k_inyp2m1m1p0k,d2_conv_nut_dydy_0_0_inyp2m1m1k_inyp2m1m1p1k &
            ,d2_conv_nut_dydy_0_0_inyp2m1m1k &
            ,d2_conv_nut_dydy_0_0_inyp2m1p1k_inyp2m1p1p0k,d2_conv_nut_dydy_0_0_inyp2m1p1k_inyp2m1p1m1k,d2_conv_nut_dydy_0_0_inyp2m1p1k_inyp2m1p1m2k &
            ,d2_conv_nut_dydy_0_0_inyp2m1p1k &
...
rhs(i,ny+2-1,indvars(5)) = rhs(i,ny+2-1,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(i,ny+2-1,indvarsst(10)))**2*(d1_dif_nut_dx_0_inyp2m1k)*(d1_dif_nut_dx_1_inyp2m1k)+&
                    ...
                    param_float(21 + 5))*((q(i,ny+2-1,indvars(4))-&
                    0.5_wp*(q(i,ny+2-1,indvars(2))*q(i,ny+2-1,indvars(2))+&
                    q(i,ny+2-1,indvars(3))*q(i,ny+2-1,indvars(3)))))/param_float(4 + 5)**1.5*q(i,ny+2-1,indvars(1)))**2)))*(qst(i,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(i,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(i,ny+2-1,indvarsst(2))**2))*q(i,ny+2-1,indvars(1))*q(i,ny+2-1,indvars(5))+&
                    ...
                    param_float(21 + 5))*((q(i,ny+2-1,indvars(4))-&
                    0.5_wp*(q(i,ny+2-1,indvars(2))*q(i,ny+2-1,indvars(2))+&
                    q(i,ny+2-1,indvars(3))*q(i,ny+2-1,indvars(3)))))/param_float(4 + 5)**1.5*q(i,ny+2-1,indvars(1)))**2)))*q(i,ny+2-1,indvars(1))*q(i,ny+2-1,indvars(5))**2/qst(i,ny+2-1,indvarsst(1))**2 ) 
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_faces_jmax_1
