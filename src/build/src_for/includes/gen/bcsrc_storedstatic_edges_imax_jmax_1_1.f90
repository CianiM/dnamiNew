...
subroutine boundarySchemestoredstatic_edges_imax_jmax_1_1(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_nxp2m1m1nyp2m1k,d1_stemp_dx_0_nxp2m1p0nyp2m1k,d1_stemp_dx_0_nxp2m1p1nyp2m1k &
            ...
            ,d1_detady_dy_0_nxp2m1nyp2m1m1k,d1_detady_dy_0_nxp2m1nyp2m1p0k,d1_detady_dy_0_nxp2m1nyp2m1p1k &
            ,d1_detady_dy_0_nxp2m1nyp2m1k &
            ,d1_dksidy_dy_0_nxp2m1nyp2m1m1k,d1_dksidy_dy_0_nxp2m1nyp2m1p0k,d1_dksidy_dy_0_nxp2m1nyp2m1p1k &
            ,d1_dksidy_dy_0_nxp2m1nyp2m1k &
            ,d1_detadx_dx_0_nxp2m1m1nyp2m1k,d1_detadx_dx_0_nxp2m1p0nyp2m1k,d1_detadx_dx_0_nxp2m1p1nyp2m1k &
            ,d1_detadx_dx_0_nxp2m1nyp2m1k &
            ,d1_dksidx_dx_0_nxp2m1m1nyp2m1k,d1_dksidx_dx_0_nxp2m1p0nyp2m1k,d1_dksidx_dx_0_nxp2m1p1nyp2m1k &
            ,d1_dksidx_dx_0_nxp2m1nyp2m1k 
...
qst(nx+2-1,ny+2-1,indvarsst(1)) =  qst(nx+2-1,ny+2-1,indvarsst(1))
...
qst(nx+2-1,ny+2-1,indvarsst(2)) =  qst(nx+2-1,ny+2-1,indvarsst(2))
...
qst(nx+2-1,ny+2-1,indvarsst(3)) =  qst(nx+2-1,ny+2-1,indvarsst(3))
...
qst(nx+2-1,ny+2-1,indvarsst(5)) =  ((sign(1.0_wp,qst(nx+2-1,ny+2-1,indvarsst(3)))-&
                    1.0_wp)/(-&
                    2.0_wp))
...
d1_detady_dy_0_nxp2m1nyp2m1m1k = qst(nx+2-1,ny+2-1-1,indvarsst(2))

d1_detady_dy_0_nxp2m1nyp2m1p1k = qst(nx+2-1,ny+2-1+1,indvarsst(2))

d1_detady_dy_0_nxp2m1nyp2m1k = -&
          0.5_wp*d1_detady_dy_0_nxp2m1nyp2m1m1k+&
          0.5_wp*d1_detady_dy_0_nxp2m1nyp2m1p1k

d1_detady_dy_0_nxp2m1nyp2m1k = d1_detady_dy_0_nxp2m1nyp2m1k*param_float(2)
...
qst(nx+2-1,ny+2-1,indvarsst(6)) =  d1_detady_dy_0_nxp2m1nyp2m1k
...
d1_dksidy_dy_0_nxp2m1nyp2m1m1k = qst(nx+2-1,ny+2-1-1,indvarsst(3))

d1_dksidy_dy_0_nxp2m1nyp2m1p1k = qst(nx+2-1,ny+2-1+1,indvarsst(3))

d1_dksidy_dy_0_nxp2m1nyp2m1k = -&
          0.5_wp*d1_dksidy_dy_0_nxp2m1nyp2m1m1k+&
          0.5_wp*d1_dksidy_dy_0_nxp2m1nyp2m1p1k

d1_dksidy_dy_0_nxp2m1nyp2m1k = d1_dksidy_dy_0_nxp2m1nyp2m1k*param_float(2)
...
qst(nx+2-1,ny+2-1,indvarsst(7)) =  d1_dksidy_dy_0_nxp2m1nyp2m1k
...
d1_detadx_dx_0_nxp2m1m1nyp2m1k = qst(nx+2-1-1,ny+2-1,indvarsst(2))

d1_detadx_dx_0_nxp2m1p1nyp2m1k = qst(nx+2-1+1,ny+2-1,indvarsst(2))

d1_detadx_dx_0_nxp2m1nyp2m1k = -&
          0.5_wp*d1_detadx_dx_0_nxp2m1m1nyp2m1k+&
          0.5_wp*d1_detadx_dx_0_nxp2m1p1nyp2m1k

d1_detadx_dx_0_nxp2m1nyp2m1k = d1_detadx_dx_0_nxp2m1nyp2m1k*param_float(1)
...
qst(nx+2-1,ny+2-1,indvarsst(8)) =  d1_detadx_dx_0_nxp2m1nyp2m1k
...
d1_dksidx_dx_0_nxp2m1m1nyp2m1k = qst(nx+2-1-1,ny+2-1,indvarsst(3))

d1_dksidx_dx_0_nxp2m1p1nyp2m1k = qst(nx+2-1+1,ny+2-1,indvarsst(3))

d1_dksidx_dx_0_nxp2m1nyp2m1k = -&
          0.5_wp*d1_dksidx_dx_0_nxp2m1m1nyp2m1k+&
          0.5_wp*d1_dksidx_dx_0_nxp2m1p1nyp2m1k

d1_dksidx_dx_0_nxp2m1nyp2m1k = d1_dksidx_dx_0_nxp2m1nyp2m1k*param_float(1)
...
qst(nx+2-1,ny+2-1,indvarsst(9)) =  (d1_dksidx_dx_0_nxp2m1nyp2m1k)
...
qst(nx+2-1,ny+2-1,indvarsst(10)) =  1.0_wp/(qst(nx+2-1,ny+2-1,indvarsst(9)))
...
qst(nx+2-1,ny+2-1,indvarsst(11)) =  1.0_wp/(qst(nx+2-1,ny+2-1,indvarsst(6)))
...
qst(nx+2-1,ny+2-1,indvarsst(13)) =  ((q(nx+2-1,ny+2-1,indvars(5))/((qst(nx+2-1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2-1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(nx+2-1,ny+2-1,indvars(5))/((qst(nx+2-1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2-1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))**6-&
                    (q(nx+2-1,ny+2-1,indvars(5))/((qst(nx+2-1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2-1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))))*(1+&
                    param_float(12 + 5)**6)/(((q(nx+2-1,ny+2-1,indvars(5))/((qst(nx+2-1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2-1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(nx+2-1,ny+2-1,indvars(5))/((qst(nx+2-1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2-1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2-1,ny+2-1,indvarsst(2))**2))**6-&
                    (q(nx+2-1,ny+2-1,indvars(5))/((qst(nx+2-1,ny+2-1,indvarsst(4))+&
...
!$OMP END DO
 ...
 end subroutine boundarySchemestoredstatic_edges_imax_jmax_1_1
