...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_detady_dy_0_1m2p0nyp2m1m1k,d1_detady_dy_0_1m2p0nyp2m1p0k,d1_detady_dy_0_1m2p0nyp2m1p1k &
...
qst(1-2+0,ny+2-1,indvarsst(19)) =  dabs(1-&
                    qst(1-2+0,ny+2-1,indvarsst(5)))
