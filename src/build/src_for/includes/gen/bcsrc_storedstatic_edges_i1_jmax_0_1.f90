...
subroutine boundarySchemestoredstatic_edges_i1_jmax_0_1(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_1m2p0p0nyp2m1k,d1_stemp_dx_0_1m2p0p1nyp2m1k,d1_stemp_dx_0_1m2p0p2nyp2m1k &
            ...
            ,d1_detady_dy_0_1m2p0nyp2m1m1k,d1_detady_dy_0_1m2p0nyp2m1p0k,d1_detady_dy_0_1m2p0nyp2m1p1k &
            ,d1_detady_dy_0_1m2p0nyp2m1k &
            ,d1_dksidy_dy_0_1m2p0nyp2m1m1k,d1_dksidy_dy_0_1m2p0nyp2m1p0k,d1_dksidy_dy_0_1m2p0nyp2m1p1k &
            ,d1_dksidy_dy_0_1m2p0nyp2m1k &
            ,d1_detadx_dx_0_1m2p0p0nyp2m1k,d1_detadx_dx_0_1m2p0p1nyp2m1k,d1_detadx_dx_0_1m2p0p2nyp2m1k &
            ,d1_detadx_dx_0_1m2p0nyp2m1k &
            ,d1_dksidx_dx_0_1m2p0p0nyp2m1k,d1_dksidx_dx_0_1m2p0p1nyp2m1k,d1_dksidx_dx_0_1m2p0p2nyp2m1k &
...
qst(1-2+0,ny+2-1,indvarsst(13)) =  ((q(1-2+0,ny+2-1,indvars(5))/((qst(1-2+0,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+0,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(1-2+0,ny+2-1,indvars(5))/((qst(1-2+0,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+0,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))**6-&
                    (q(1-2+0,ny+2-1,indvars(5))/((qst(1-2+0,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+0,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))))*(1+&
                    param_float(12 + 5)**6)/(((q(1-2+0,ny+2-1,indvars(5))/((qst(1-2+0,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+0,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(1-2+0,ny+2-1,indvars(5))/((qst(1-2+0,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+0,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+0,ny+2-1,indvarsst(2))**2))**6-&
                    (q(1-2+0,ny+2-1,indvars(5))/((qst(1-2+0,ny+2-1,indvarsst(4))+&
...
!$OMP END DO
 ...
 end subroutine boundarySchemestoredstatic_edges_i1_jmax_0_1
