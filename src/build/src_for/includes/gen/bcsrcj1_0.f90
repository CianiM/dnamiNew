...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_conv_rho_dx_0_im11m2p0k,d1_conv_rho_dx_0_ip01m2p0k,d1_conv_rho_dx_0_ip11m2p0k &
            ...
            ,d2_conv_nut_dxdx_0_0_im11m2p0k_im1m11m2p0k,d2_conv_nut_dxdx_0_0_im11m2p0k_im1p01m2p0k,d2_conv_nut_dxdx_0_0_im11m2p0k_im1p11m2p0k &
            ,d2_conv_nut_dxdx_0_0_im11m2p0k &
            ,d2_conv_nut_dxdx_0_0_ip11m2p0k_ip1m11m2p0k,d2_conv_nut_dxdx_0_0_ip11m2p0k_ip1p01m2p0k,d2_conv_nut_dxdx_0_0_ip11m2p0k_ip1p11m2p0k &
            ,d2_conv_nut_dxdx_0_0_ip11m2p0k &
            ,d1_conv_nut_dx_0_im11m2p0k,d1_conv_nut_dx_0_ip01m2p0k,d1_conv_nut_dx_0_ip11m2p0k &
            ,d1_conv_nut_dx_0_i1m2p0k &
            ,d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p0k,d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p1k,d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p2k &
            ,d2_conv_nut_dydy_0_0_i1m2p0p0k &
            ,d2_conv_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1m1k,d2_conv_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1p0k,d2_conv_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1p1k &
            ,d2_conv_nut_dydy_0_0_i1m2p0p1k &
            ,d2_conv_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2m1k,d2_conv_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2p0k,d2_conv_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2p1k &
            ,d2_conv_nut_dydy_0_0_i1m2p0p2k &
            ,d1_conv_nut_dy_0_i1m2p0p0k,d1_conv_nut_dy_0_i1m2p0p1k,d1_conv_nut_dy_0_i1m2p0p2k &
 ...
 real(wp) ::  d2_dif_rhou_dxdx_0_0_im11m2p0k_im1m11m2p0k,d2_dif_rhou_dxdx_0_0_im11m2p0k_im1p01m2p0k,d2_dif_rhou_dxdx_0_0_im11m2p0k_im1p11m2p0k &
            ...
            ,d1_dif_nut_dx_0_im11m2p0k,d1_dif_nut_dx_0_ip01m2p0k,d1_dif_nut_dx_0_ip11m2p0k &
            ,d1_dif_nut_dx_0_i1m2p0k &
            ,d1_dif_nut_dx_1_im11m2p0k,d1_dif_nut_dx_1_ip01m2p0k,d1_dif_nut_dx_1_ip11m2p0k &
            ,d1_dif_nut_dx_1_i1m2p0k &
            ,d1_dif_nut_dy_0_i1m2p0p0k,d1_dif_nut_dy_0_i1m2p0p1k,d1_dif_nut_dy_0_i1m2p0p2k &
            ,d1_dif_nut_dy_0_i1m2p0k &
            ,d1_dif_nut_dy_1_i1m2p0p0k,d1_dif_nut_dy_1_i1m2p0p1k,d1_dif_nut_dy_1_i1m2p0p2k &
...
d2_conv_nut_dxdx_0_0_im11m2p0k_im1m11m2p0k = q(i-1-1,1-2+0,indvars(5))

d2_conv_nut_dxdx_0_0_im11m2p0k_im1p11m2p0k = q(i-1+1,1-2+0,indvars(5))

d2_conv_nut_dxdx_0_0_im11m2p0k = -&
          0.5_wp*d2_conv_nut_dxdx_0_0_im11m2p0k_im1m11m2p0k+&
          0.5_wp*d2_conv_nut_dxdx_0_0_im11m2p0k_im1p11m2p0k

d2_conv_nut_dxdx_0_0_im11m2p0k = d2_conv_nut_dxdx_0_0_im11m2p0k*param_float(1)

d2_conv_nut_dxdx_0_0_ip11m2p0k_ip1m11m2p0k = q(i+1-1,1-2+0,indvars(5))

d2_conv_nut_dxdx_0_0_ip11m2p0k_ip1p11m2p0k = q(i+1+1,1-2+0,indvars(5))

d2_conv_nut_dxdx_0_0_ip11m2p0k = -&
          0.5_wp*d2_conv_nut_dxdx_0_0_ip11m2p0k_ip1m11m2p0k+&
          0.5_wp*d2_conv_nut_dxdx_0_0_ip11m2p0k_ip1p11m2p0k

d2_conv_nut_dxdx_0_0_ip11m2p0k = d2_conv_nut_dxdx_0_0_ip11m2p0k*param_float(1)
...
d1_conv_nut_dx_0_im11m2p0k = q(i-1,1-2+0,indvars(1))*q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5)*(1+&
                    ((q(i-1,1-2+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-2+0,indvars(1)))**3/((q(i-1,1-2+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-2+0,indvars(1)))**3+&
                    param_float(13 + 5)**3))*(q(i-1,1-2+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-2+0,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(i-1,1-2+0,indvarsst(10))*(d2_conv_nut_dxdx_0_0_im11m2p0k)
...
d1_conv_nut_dx_0_ip11m2p0k = q(i+1,1-2+0,indvars(1))*q(i+1,1-2+0,indvars(2))*q(i+1,1-2+0,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(i+1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-2+0,indvars(2))*q(i+1,1-2+0,indvars(2))+&
                    q(i+1,1-2+0,indvars(3))*q(i+1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i+1,1-2+0,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(i+1,1-2+0,indvarsst(10))*(d2_conv_nut_dxdx_0_0_ip11m2p0k)
...
d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p0k = q(i,1-2+0+0+0,indvars(5))

d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p1k = q(i,1-2+0+0+1,indvars(5))

d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p2k = q(i,1-2+0+0+2,indvars(5))

d2_conv_nut_dydy_0_0_i1m2p0p0k = -&
          1.5_wp*d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p0k+&
          2.0_wp*d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p1k-&
          0.5_wp*d2_conv_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p2k

d2_conv_nut_dydy_0_0_i1m2p0p0k = d2_conv_nut_dydy_0_0_i1m2p0p0k*param_float(2)

d2_conv_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1m1k = q(i,1-2+0+1-1,indvars(5))

d2_conv_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1p1k = q(i,1-2+0+1+1,indvars(5))

d2_conv_nut_dydy_0_0_i1m2p0p1k = -&
          0.5_wp*d2_conv_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1m1k+&
          0.5_wp*d2_conv_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1p1k

d2_conv_nut_dydy_0_0_i1m2p0p1k = d2_conv_nut_dydy_0_0_i1m2p0p1k*param_float(2)

d2_conv_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2m1k = q(i,1-2+0+2-1,indvars(5))

d2_conv_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2p1k = q(i,1-2+0+2+1,indvars(5))

d2_conv_nut_dydy_0_0_i1m2p0p2k = -&
          0.5_wp*d2_conv_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2m1k+&
          0.5_wp*d2_conv_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2p1k

d2_conv_nut_dydy_0_0_i1m2p0p2k = d2_conv_nut_dydy_0_0_i1m2p0p2k*param_float(2)
...
d1_conv_nut_dy_0_i1m2p0p0k = q(i,1-2+0+0,indvars(1))*q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)**1.5)*(1+&
                    ((q(i,1-2+0+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+0,indvars(1)))**3/((q(i,1-2+0+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+0,indvars(1)))**3+&
                    param_float(13 + 5)**3))*(q(i,1-2+0+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+0,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(i,1-2+0+0,indvarsst(11))*(d2_conv_nut_dydy_0_0_i1m2p0p0k)
...
d1_conv_nut_dy_0_i1m2p0p1k = q(i,1-2+0+1,indvars(1))*q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)**1.5)*(1+&
                    ((q(i,1-2+0+1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+1,indvars(1)))**3/((q(i,1-2+0+1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+1,indvars(1)))**3+&
                    param_float(13 + 5)**3))*(q(i,1-2+0+1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(i,1-2+0+1,indvarsst(11))*(d2_conv_nut_dydy_0_0_i1m2p0p1k)
...
d1_conv_nut_dy_0_i1m2p0p2k = q(i,1-2+0+2,indvars(1))*q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)**1.5)*(1+&
                    ((q(i,1-2+0+2,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+2,indvars(1)))**3/((q(i,1-2+0+2,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+2,indvars(1)))**3+&
                    param_float(13 + 5)**3))*(q(i,1-2+0+2,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+2,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(i,1-2+0+2,indvarsst(11))*(d2_conv_nut_dydy_0_0_i1m2p0p2k)
...
d1_dif_rhou_dx_0_im11m2p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-2+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i-1,1-2+0,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_im11m2p0k)-&
...
d1_dif_rhou_dx_0_ip11m2p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i+1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-2+0,indvars(2))*q(i+1,1-2+0,indvars(2))+&
                    q(i+1,1-2+0,indvars(3))*q(i+1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i+1,1-2+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i+1,1-2+0,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_ip11m2p0k)-&
...
d1_dif_rhou_dy_0_i1m2p0p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+0,indvars(1))))*param_float(1 + 5)*(qst(i,1-2+0+0,indvarsst(11))*(d2_dif_rhou_dydy_0_0_i1m2p0p0k)+&
...
d1_dif_rhou_dy_0_i1m2p0p1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+1,indvars(1))))*param_float(1 + 5)*(qst(i,1-2+0+1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_i1m2p0p1k)+&
...
d1_dif_rhou_dy_0_i1m2p0p2k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+2,indvars(1))))*param_float(1 + 5)*(qst(i,1-2+0+2,indvarsst(11))*(d2_dif_rhou_dydy_0_0_i1m2p0p2k)+&
...
d1_dif_rhov_dx_0_im11m2p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i-1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-2+0,indvars(2))*q(i-1,1-2+0,indvars(2))+&
                    q(i-1,1-2+0,indvars(3))*q(i-1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-2+0,indvars(1))))*param_float(1 + 5)*(qst(i-1,1-2+0,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_im11m2p0k)+&
...
d1_dif_rhov_dx_0_ip11m2p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i+1,1-2+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-2+0,indvars(2))*q(i+1,1-2+0,indvars(2))+&
                    q(i+1,1-2+0,indvars(3))*q(i+1,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i+1,1-2+0,indvars(1))))*param_float(1 + 5)*(qst(i+1,1-2+0,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_ip11m2p0k)+&
...
d1_dif_rhov_dy_0_i1m2p0p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+0,indvars(2))*q(i,1-2+0+0,indvars(2))+&
                    q(i,1-2+0+0,indvars(3))*q(i,1-2+0+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i,1-2+0+0,indvarsst(11))*(d2_dif_rhov_dydy_0_0_i1m2p0p0k)-&
...
d1_dif_rhov_dy_0_i1m2p0p1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+1,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+1,indvars(2))*q(i,1-2+0+1,indvars(2))+&
                    q(i,1-2+0+1,indvars(3))*q(i,1-2+0+1,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i,1-2+0+1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_i1m2p0p1k)-&
...
d1_dif_rhov_dy_0_i1m2p0p2k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0+2,indvars(4))-&
                    0.5_wp*(q(i,1-2+0+2,indvars(2))*q(i,1-2+0+2,indvars(2))+&
                    q(i,1-2+0+2,indvars(3))*q(i,1-2+0+2,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0+2,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i,1-2+0+2,indvarsst(11))*(d2_dif_rhov_dydy_0_0_i1m2p0p2k)-&
...
d1_dif_nut_dx_0_im11m2p0k = q(i-1,1-2+0,indvars(1))*q(i-1,1-2+0,indvars(5))

d1_dif_nut_dx_0_ip11m2p0k = q(i+1,1-2+0,indvars(1))*q(i+1,1-2+0,indvars(5))
...
d1_dif_nut_dx_1_im11m2p0k = q(i-1,1-2+0,indvars(5))

d1_dif_nut_dx_1_ip11m2p0k = q(i+1,1-2+0,indvars(5))
...
d1_dif_nut_dy_0_i1m2p0p0k = q(i,1-2+0+0,indvars(1))*q(i,1-2+0+0,indvars(5))

d1_dif_nut_dy_0_i1m2p0p1k = q(i,1-2+0+1,indvars(1))*q(i,1-2+0+1,indvars(5))

d1_dif_nut_dy_0_i1m2p0p2k = q(i,1-2+0+2,indvars(1))*q(i,1-2+0+2,indvars(5))
...
d1_dif_nut_dy_1_i1m2p0p0k = q(i,1-2+0+0,indvars(5))

d1_dif_nut_dy_1_i1m2p0p1k = q(i,1-2+0+1,indvars(5))

d1_dif_nut_dy_1_i1m2p0p2k = q(i,1-2+0+2,indvars(5))
...
rhs(i,1-2+0,indvars(5)) = rhs(i,1-2+0,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(i,1-2+0,indvarsst(10)))**2*(d1_dif_nut_dx_0_i1m2p0k)*(d1_dif_nut_dx_1_i1m2p0k)+&
                    (qst(i,1-2+0,indvarsst(11)))**2*(d1_dif_nut_dy_0_i1m2p0k)*(d1_dif_nut_dy_1_i1m2p0k))-&
                    param_float(6 + 5)*(1-&
                    ...
                    param_float(21 + 5))*((q(i,1-2+0,indvars(4))-&
                    0.5_wp*(q(i,1-2+0,indvars(2))*q(i,1-2+0,indvars(2))+&
                    q(i,1-2+0,indvars(3))*q(i,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-2+0,indvars(1)))**2)))*q(i,1-2+0,indvars(1))*q(i,1-2+0,indvars(5))**2/qst(i,1-2+0,indvarsst(1))**2 ) 
