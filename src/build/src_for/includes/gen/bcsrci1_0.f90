...
subroutine boundaryScheme_faces_i1_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_conv_rho_dx_0_1m2p0p0jk,d1_conv_rho_dx_0_1m2p0p1jk,d1_conv_rho_dx_0_1m2p0p2jk &
            ...
            ,d2_conv_nut_dxdx_0_0_1m2p0p0jk_1m2p0p0p0jk,d2_conv_nut_dxdx_0_0_1m2p0p0jk_1m2p0p0p1jk,d2_conv_nut_dxdx_0_0_1m2p0p0jk_1m2p0p0p2jk &
            ,d2_conv_nut_dxdx_0_0_1m2p0p0jk &
            ,d2_conv_nut_dxdx_0_0_1m2p0p1jk_1m2p0p1m1jk,d2_conv_nut_dxdx_0_0_1m2p0p1jk_1m2p0p1p0jk,d2_conv_nut_dxdx_0_0_1m2p0p1jk_1m2p0p1p1jk &
            ,d2_conv_nut_dxdx_0_0_1m2p0p1jk &
            ,d2_conv_nut_dxdx_0_0_1m2p0p2jk_1m2p0p2m1jk,d2_conv_nut_dxdx_0_0_1m2p0p2jk_1m2p0p2p0jk,d2_conv_nut_dxdx_0_0_1m2p0p2jk_1m2p0p2p1jk &
            ...
            ,d2_conv_nut_dydy_0_0_1m2p0jm1k_1m2p0jm1m1k,d2_conv_nut_dydy_0_0_1m2p0jm1k_1m2p0jm1p0k,d2_conv_nut_dydy_0_0_1m2p0jm1k_1m2p0jm1p1k &
            ,d2_conv_nut_dydy_0_0_1m2p0jm1k &
            ,d2_conv_nut_dydy_0_0_1m2p0jp1k_1m2p0jp1m1k,d2_conv_nut_dydy_0_0_1m2p0jp1k_1m2p0jp1p0k,d2_conv_nut_dydy_0_0_1m2p0jp1k_1m2p0jp1p1k &
...
rhs(1-2+0,j,indvars(5)) = rhs(1-2+0,j,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(1-2+0,j,indvarsst(10)))**2*(d1_dif_nut_dx_0_1m2p0jk)*(d1_dif_nut_dx_1_1m2p0jk)+&
                    ...
                    param_float(21 + 5))*((q(1-2+0,j,indvars(4))-&
                    0.5_wp*(q(1-2+0,j,indvars(2))*q(1-2+0,j,indvars(2))+&
                    q(1-2+0,j,indvars(3))*q(1-2+0,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-2+0,j,indvars(1)))**2)))*(qst(1-2+0,j,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+0,j,indvars(5))/(param_float(9 + 5)**2*qst(1-2+0,j,indvarsst(2))**2))*q(1-2+0,j,indvars(1))*q(1-2+0,j,indvars(5))+&
                    ...
                    param_float(21 + 5))*((q(1-2+0,j,indvars(4))-&
                    0.5_wp*(q(1-2+0,j,indvars(2))*q(1-2+0,j,indvars(2))+&
                    q(1-2+0,j,indvars(3))*q(1-2+0,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-2+0,j,indvars(1)))**2)))*q(1-2+0,j,indvars(1))*q(1-2+0,j,indvars(5))**2/qst(1-2+0,j,indvarsst(1))**2 ) 
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_faces_i1_0
