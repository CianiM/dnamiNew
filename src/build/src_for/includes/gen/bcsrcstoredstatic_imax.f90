...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_nxp2p0p0jk,d1_stemp_dx_0_nxp2p0m1jk,d1_stemp_dx_0_nxp2p0m2jk &
            ...
            ,d1_detady_dy_0_nxp2p0jm1k,d1_detady_dy_0_nxp2p0jp0k,d1_detady_dy_0_nxp2p0jp1k &
 ...
 real(wp) ::  d1_stemp_dx_0_nxp2m1m1jk,d1_stemp_dx_0_nxp2m1p0jk,d1_stemp_dx_0_nxp2m1p1jk &
            ...
            ,d1_detady_dy_0_nxp2m1jm1k,d1_detady_dy_0_nxp2m1jp0k,d1_detady_dy_0_nxp2m1jp1k &
...
qst(nx+2+0,j,indvarsst(14)) =  (q(nx+2+0,j,indvars(5))/((qst(nx+2+0,j,indvarsst(4))+&
...
qst(nx+2-1,j,indvarsst(14)) =  (q(nx+2-1,j,indvars(5))/((qst(nx+2-1,j,indvarsst(4))+&
