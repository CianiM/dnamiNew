...
subroutine boundarySchemestoredstatic_edges_imax_j1_0_1(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_nxp2p0p01m2p1k,d1_stemp_dx_0_nxp2p0m11m2p1k,d1_stemp_dx_0_nxp2p0m21m2p1k &
            ...
            ,d1_detady_dy_0_nxp2p01m2p1m1k,d1_detady_dy_0_nxp2p01m2p1p0k,d1_detady_dy_0_nxp2p01m2p1p1k &
            ,d1_detady_dy_0_nxp2p01m2p1k &
            ,d1_dksidy_dy_0_nxp2p01m2p1m1k,d1_dksidy_dy_0_nxp2p01m2p1p0k,d1_dksidy_dy_0_nxp2p01m2p1p1k &
            ,d1_dksidy_dy_0_nxp2p01m2p1k &
            ,d1_detadx_dx_0_nxp2p0p01m2p1k,d1_detadx_dx_0_nxp2p0m11m2p1k,d1_detadx_dx_0_nxp2p0m21m2p1k &
            ,d1_detadx_dx_0_nxp2p01m2p1k &
            ,d1_dksidx_dx_0_nxp2p0p01m2p1k,d1_dksidx_dx_0_nxp2p0m11m2p1k,d1_dksidx_dx_0_nxp2p0m21m2p1k &
            ,d1_dksidx_dx_0_nxp2p01m2p1k 
...
qst(nx+2+0,1-2+1,indvarsst(13)) =  ((q(nx+2+0,1-2+1,indvars(5))/((qst(nx+2+0,1-2+1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(nx+2+0,1-2+1,indvars(5))/((qst(nx+2+0,1-2+1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))**6-&
                    (q(nx+2+0,1-2+1,indvars(5))/((qst(nx+2+0,1-2+1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))))*(1+&
                    param_float(12 + 5)**6)/(((q(nx+2+0,1-2+1,indvars(5))/((qst(nx+2+0,1-2+1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(nx+2+0,1-2+1,indvars(5))/((qst(nx+2+0,1-2+1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))**6-&
                    (q(nx+2+0,1-2+1,indvars(5))/((qst(nx+2+0,1-2+1,indvarsst(4))+&
...
!$OMP END DO
 ...
 end subroutine boundarySchemestoredstatic_edges_imax_j1_0_1
