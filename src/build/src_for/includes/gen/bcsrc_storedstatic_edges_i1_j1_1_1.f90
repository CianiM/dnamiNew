...
qst(1-2+1,1-2+1,indvarsst(13)) =  qst(1-2+1,1-2+1,indvarsst(14))*(1+&
                    param_float(12 + 5)**6)/(qst(1-2+1,1-2+1,indvarsst(14))**6+&
                    param_float(12 + 5)**6)
...
qst(1-2+1,1-2+1,indvarsst(14)) =  (q(1-2+1,1-2+1,indvars(5))/((qst(1-2+1,1-2+1,indvarsst(4))+&
