...
rhs(i,ny+2+0,indvars(5)) = rhs(i,ny+2+0,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(i,ny+2+0,indvarsst(10)))**2*(d1_dif_nut_dx_0_inyp2p0k)*(d1_dif_nut_dx_1_inyp2p0k)+&
                    ...
                    param_float(6 + 5)*(1-&
                    qst(i,ny+2+0,indvarsst(16)))*qst(i,ny+2+0,indvarsst(20))*q(i,ny+2+0,indvars(1))*q(i,ny+2+0,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*qst(i,ny+2+0,indvarsst(13))-&
                    param_float(6 + 5)/param_float(9 + 5)**2*qst(i,ny+2+0,indvarsst(16)))*q(i,ny+2+0,indvars(1))*q(i,ny+2+0,indvars(5))**2/qst(i,ny+2+0,indvarsst(2))**2 ) 
