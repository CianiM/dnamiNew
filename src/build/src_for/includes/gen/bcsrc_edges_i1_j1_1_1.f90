...
rhs(1-2+1,1-2+1,indvars(5)) = rhs(1-2+1,1-2+1,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(1-2+1,1-2+1,indvarsst(10)))**2*(d1_dif_nut_dx_0_1m2p11m2p1k)*(d1_dif_nut_dx_1_1m2p11m2p1k)+&
                    ...
                    param_float(6 + 5)*(1-&
                    qst(1-2+1,1-2+1,indvarsst(16)))*qst(1-2+1,1-2+1,indvarsst(20))*q(1-2+1,1-2+1,indvars(1))*q(1-2+1,1-2+1,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*qst(1-2+1,1-2+1,indvarsst(13))-&
                    param_float(6 + 5)/param_float(9 + 5)**2*qst(1-2+1,1-2+1,indvarsst(16)))*q(1-2+1,1-2+1,indvars(1))*q(1-2+1,1-2+1,indvars(5))**2/qst(1-2+1,1-2+1,indvarsst(2))**2 ) 
