...
subroutine boundaryScheme_edges_PhyBC_Low_surf_rhs_j1_imax_0_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_rhs_rho_dx_0_nxp2p0p01m2p0k,d1_rhs_rho_dx_0_nxp2p0m11m2p0k,d1_rhs_rho_dx_0_nxp2p0m21m2p0k &
            ...
            ,d2_rhs_nut_dxdx_2_0_nxp2p0p01m2p0k_nxp2p0p0p01m2p0k,d2_rhs_nut_dxdx_2_0_nxp2p0p01m2p0k_nxp2p0p0m11m2p0k,d2_rhs_nut_dxdx_2_0_nxp2p0p01m2p0k_nxp2p0p0m21m2p0k &
            ,d2_rhs_nut_dxdx_2_0_nxp2p0p01m2p0k &
            ,d2_rhs_nut_dxdx_2_0_nxp2p0m11m2p0k_nxp2p0m1m11m2p0k,d2_rhs_nut_dxdx_2_0_nxp2p0m11m2p0k_nxp2p0m1p01m2p0k,d2_rhs_nut_dxdx_2_0_nxp2p0m11m2p0k_nxp2p0m1p11m2p0k &
            ,d2_rhs_nut_dxdx_2_0_nxp2p0m11m2p0k &
            ,d2_rhs_nut_dxdx_2_0_nxp2p0m21m2p0k_nxp2p0m2m11m2p0k,d2_rhs_nut_dxdx_2_0_nxp2p0m21m2p0k_nxp2p0m2p01m2p0k,d2_rhs_nut_dxdx_2_0_nxp2p0m21m2p0k_nxp2p0m2p11m2p0k &
...
rhs(nx+2+0,1-2+0,indvars(1)) =   -  ( (qst(nx+2+0,1-2+0,indvarsst(10))*(d1_rhs_rho_dx_0_nxp2p01m2p0k))*qst(nx+2+0,1-2+0,indvarsst(5))+&
                    (q(nx+2+0,1-2+0,indvars(1))*(d1_rhs_rho_dy_0_nxp2p01m2p0k)*qst(nx+2+0,1-2+0,indvarsst(11)))*dabs(1-&
                    qst(nx+2+0,1-2+0,indvarsst(5))) ) 
...
rhs(nx+2+0,1-2+0,indvars(4)) =   -  ( (qst(nx+2+0,1-2+0,indvarsst(10))*(d1_rhs_et_dx_0_nxp2p01m2p0k)+&
                    ...
                    0.5_wp*(q(nx+2+0,1-2+0,indvars(2))*q(nx+2+0,1-2+0,indvars(2))+&
                    q(nx+2+0,1-2+0,indvars(3))*q(nx+2+0,1-2+0,indvars(3))))))*(d1_rhs_rho_dy_0_nxp2p01m2p0k)*qst(nx+2+0,1-2+0,indvarsst(11)))*dabs(1-&
                    qst(nx+2+0,1-2+0,indvarsst(5))) ) 
...
rhs(nx+2+0,1-2+0,indvars(5)) =   -  ( (-&
                    ...
                    param_float(21 + 5))*((q(nx+2+0,1-2+0,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+0,indvars(2))*q(nx+2+0,1-2+0,indvars(2))+&
                    q(nx+2+0,1-2+0,indvars(3))*q(nx+2+0,1-2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2+0,1-2+0,indvars(1)))**2)))*q(nx+2+0,1-2+0,indvars(1))*q(nx+2+0,1-2+0,indvars(5))**2/qst(nx+2+0,1-2+0,indvarsst(2))**2+&
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_PhyBC_Low_surf_rhs_j1_imax_0_0
