...
rhs(1-2+1,j,indvars(5)) = rhs(1-2+1,j,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(1-2+1,j,indvarsst(10)))**2*(d1_dif_nut_dx_0_1m2p1jk)*(d1_dif_nut_dx_1_1m2p1jk)+&
                    ...
                    param_float(6 + 5)*(1-&
                    qst(1-2+1,j,indvarsst(16)))*qst(1-2+1,j,indvarsst(20))*q(1-2+1,j,indvars(1))*q(1-2+1,j,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*qst(1-2+1,j,indvarsst(13))-&
                    param_float(6 + 5)/param_float(9 + 5)**2*qst(1-2+1,j,indvarsst(16)))*q(1-2+1,j,indvars(1))*q(1-2+1,j,indvars(5))**2/qst(1-2+1,j,indvarsst(2))**2 ) 
