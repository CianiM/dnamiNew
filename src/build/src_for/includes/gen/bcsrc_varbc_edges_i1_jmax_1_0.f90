...
subroutine boundarySchemevarbc_edges_i1_jmax_1_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
!***********************************************************
!                                                           
! building source terms in RHS for layer 1 0 None M_jmax ***
!                                                           
!***********************************************************
...
!***********************************************************
!                                                           
! Update BC terms for layer 1 0 None M_jmax ****************
!                                                           
!***********************************************************


qface_j(1-2+1,1) =  (q(1-2+1,ny+2+0,indvars(2))/(param_float(23 + 5)*(param_float(3 + 5))*q(1-2+1,ny+2+0,indvars(1))*((q(1-2+1,ny+2+0,indvars(4))-&
...
!$OMP END DO
 ...
 end subroutine boundarySchemevarbc_edges_i1_jmax_1_0
