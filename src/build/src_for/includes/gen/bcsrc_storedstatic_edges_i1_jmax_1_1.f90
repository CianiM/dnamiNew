...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_1m2p1m1nyp2m1k,d1_stemp_dx_0_1m2p1p0nyp2m1k,d1_stemp_dx_0_1m2p1p1nyp2m1k &
            ...
            ,d1_detady_dy_0_1m2p1nyp2m1m1k,d1_detady_dy_0_1m2p1nyp2m1p0k,d1_detady_dy_0_1m2p1nyp2m1p1k &
...
qst(1-2+1,ny+2-1,indvarsst(13)) =  ((q(1-2+1,ny+2-1,indvars(5))/((qst(1-2+1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(1-2+1,ny+2-1,indvars(5))/((qst(1-2+1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))**6-&
                    (q(1-2+1,ny+2-1,indvars(5))/((qst(1-2+1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))))*(1+&
                    param_float(12 + 5)**6)/(((q(1-2+1,ny+2-1,indvars(5))/((qst(1-2+1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(1-2+1,ny+2-1,indvars(5))/((qst(1-2+1,ny+2-1,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,ny+2-1,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,ny+2-1,indvarsst(2))**2))**6-&
                    (q(1-2+1,ny+2-1,indvars(5))/((qst(1-2+1,ny+2-1,indvarsst(4))+&
