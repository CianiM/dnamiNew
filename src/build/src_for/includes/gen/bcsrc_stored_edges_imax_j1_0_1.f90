...
subroutine boundarySchemestored_edges_imax_j1_0_1(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_nxp2p0p01m2p1k,d1_stemp_dx_0_nxp2p0m11m2p1k,d1_stemp_dx_0_nxp2p0m21m2p1k &
            ,d1_stemp_dx_0_nxp2p01m2p1k &
            ,d1_stemp_dy_0_nxp2p01m2p1m1k,d1_stemp_dy_0_nxp2p01m2p1p0k,d1_stemp_dy_0_nxp2p01m2p1p1k &
...
qst(nx+2+0,1-2+1,indvarsst(12)) =  (1+&
                    ...
                    param_float(21 + 5))*((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)**1.5
...
qst(nx+2+0,1-2+1,indvarsst(13)) =  qst(nx+2+0,1-2+1,indvarsst(14))*(1+&
                    param_float(12 + 5)**6)/(qst(nx+2+0,1-2+1,indvarsst(14))**6+&
                    param_float(12 + 5)**6)
...
qst(nx+2+0,1-2+1,indvarsst(14)) =  (q(nx+2+0,1-2+1,indvars(5))/(qst(nx+2+0,1-2+1,indvarsst(20))*param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))
...
qst(nx+2+0,1-2+1,indvarsst(15)) =  (1-&
                    (q(nx+2+0,1-2+1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2+0,1-2+1,indvars(1)))/(1+&
                    (q(nx+2+0,1-2+1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2+0,1-2+1,indvars(1)))*((q(nx+2+0,1-2+1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2+0,1-2+1,indvars(1)))**3/((q(nx+2+0,1-2+1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2+0,1-2+1,indvars(1)))**3+&
                    param_float(13 + 5)**3))))
...
qst(nx+2+0,1-2+1,indvarsst(16)) =  (param_float(16 + 5)*exp(-&
                    ...
                    param_float(21 + 5))*((q(nx+2+0,1-2+1,indvars(4))-&
                    0.5_wp*(q(nx+2+0,1-2+1,indvars(2))*q(nx+2+0,1-2+1,indvars(2))+&
                    q(nx+2+0,1-2+1,indvars(3))*q(nx+2+0,1-2+1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2+0,1-2+1,indvars(1)))**2))
...
qst(nx+2+0,1-2+1,indvarsst(17)) =  (qst(nx+2+0,1-2+1,indvarsst(14))*(1+&
                    param_float(12 + 5)**6)/(qst(nx+2+0,1-2+1,indvarsst(14))**6+&
                    param_float(12 + 5)**6))
...
qst(nx+2+0,1-2+1,indvarsst(18)) =  (q(nx+2+0,1-2+1,indvars(5))/(qst(nx+2+0,1-2+1,indvarsst(20))*param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))
...
qst(nx+2+0,1-2+1,indvarsst(20)) =  (qst(nx+2+0,1-2+1,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+1,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+1,indvarsst(2))**2))
...
!$OMP END DO
 ...
 end subroutine boundarySchemestored_edges_imax_j1_0_1
