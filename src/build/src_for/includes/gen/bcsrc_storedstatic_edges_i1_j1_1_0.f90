...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_1m2p1m11m2p0k,d1_stemp_dx_0_1m2p1p01m2p0k,d1_stemp_dx_0_1m2p1p11m2p0k &
            ...
            ,d1_detady_dy_0_1m2p11m2p0p0k,d1_detady_dy_0_1m2p11m2p0p1k,d1_detady_dy_0_1m2p11m2p0p2k &
...
qst(1-2+1,1-2+0,indvarsst(13)) =  ((q(1-2+1,1-2+0,indvars(5))/((qst(1-2+1,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(1-2+1,1-2+0,indvars(5))/((qst(1-2+1,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))**6-&
                    (q(1-2+1,1-2+0,indvars(5))/((qst(1-2+1,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))))*(1+&
                    param_float(12 + 5)**6)/(((q(1-2+1,1-2+0,indvars(5))/((qst(1-2+1,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(1-2+1,1-2+0,indvars(5))/((qst(1-2+1,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+1,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(1-2+1,1-2+0,indvarsst(2))**2))**6-&
                    (q(1-2+1,1-2+0,indvars(5))/((qst(1-2+1,1-2+0,indvarsst(4))+&
