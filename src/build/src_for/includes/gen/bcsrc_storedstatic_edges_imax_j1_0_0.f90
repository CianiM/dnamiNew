...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_nxp2p0p01m2p0k,d1_stemp_dx_0_nxp2p0m11m2p0k,d1_stemp_dx_0_nxp2p0m21m2p0k &
            ...
            ,d1_detady_dy_0_nxp2p01m2p0p0k,d1_detady_dy_0_nxp2p01m2p0p1k,d1_detady_dy_0_nxp2p01m2p0p2k &
...
qst(nx+2+0,1-2+0,indvarsst(13)) =  ((q(nx+2+0,1-2+0,indvars(5))/((qst(nx+2+0,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(nx+2+0,1-2+0,indvars(5))/((qst(nx+2+0,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))**6-&
                    (q(nx+2+0,1-2+0,indvars(5))/((qst(nx+2+0,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))))*(1+&
                    param_float(12 + 5)**6)/(((q(nx+2+0,1-2+0,indvars(5))/((qst(nx+2+0,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(nx+2+0,1-2+0,indvars(5))/((qst(nx+2+0,1-2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2+0,1-2+0,indvars(5))/(param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))*param_float(9 + 5)**2*qst(nx+2+0,1-2+0,indvarsst(2))**2))**6-&
                    (q(nx+2+0,1-2+0,indvars(5))/((qst(nx+2+0,1-2+0,indvarsst(4))+&
