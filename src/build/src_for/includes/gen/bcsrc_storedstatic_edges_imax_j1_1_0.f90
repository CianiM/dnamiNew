...
qst(nx+2-1,1-2+0,indvarsst(13)) =  qst(nx+2-1,1-2+0,indvarsst(14))*(1+&
                    param_float(12 + 5)**6)/(qst(nx+2-1,1-2+0,indvarsst(14))**6+&
                    param_float(12 + 5)**6)
...
qst(nx+2-1,1-2+0,indvarsst(14)) =  (q(nx+2-1,1-2+0,indvars(5))/((qst(nx+2-1,1-2+0,indvarsst(4))+&
