...
subroutine boundarySchemestored_edges_i1_jmax_0_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
qst(1-2+0,ny+2+0,indvarsst(14)) =  (q(1-2+0,ny+2+0,indvars(5))/(qst(1-2+0,ny+2+0,indvarsst(20))*param_float(9 + 5)**2*qst(1-2+0,ny+2+0,indvarsst(2))**2))
...
qst(1-2+0,ny+2+0,indvarsst(15)) =  (1-&
                    (q(1-2+0,ny+2+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(1-2+0,ny+2+0,indvars(1)))/(1+&
                    (q(1-2+0,ny+2+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(1-2+0,ny+2+0,indvars(1)))*((q(1-2+0,ny+2+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(1-2+0,ny+2+0,indvars(1)))**3/((q(1-2+0,ny+2+0,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(1-2+0,ny+2+0,indvars(1)))**3+&
                    param_float(13 + 5)**3))))
...
qst(1-2+0,ny+2+0,indvarsst(16)) =  (param_float(16 + 5)*exp(-&
                    ...
                    param_float(21 + 5))*((q(1-2+0,ny+2+0,indvars(4))-&
                    0.5_wp*(q(1-2+0,ny+2+0,indvars(2))*q(1-2+0,ny+2+0,indvars(2))+&
                    q(1-2+0,ny+2+0,indvars(3))*q(1-2+0,ny+2+0,indvars(3)))))/param_float(4 + 5)**1.5*q(1-2+0,ny+2+0,indvars(1)))**2))
...
qst(1-2+0,ny+2+0,indvarsst(17)) =  (qst(1-2+0,ny+2+0,indvarsst(14))*(1+&
                    param_float(12 + 5)**6)/(qst(1-2+0,ny+2+0,indvarsst(14))**6+&
                    param_float(12 + 5)**6))
...
qst(1-2+0,ny+2+0,indvarsst(18)) =  (q(1-2+0,ny+2+0,indvars(5))/(qst(1-2+0,ny+2+0,indvarsst(20))*param_float(9 + 5)**2*qst(1-2+0,ny+2+0,indvarsst(2))**2))
...
qst(1-2+0,ny+2+0,indvarsst(20)) =  (qst(1-2+0,ny+2+0,indvarsst(4))+&
                    param_float(1 + 5)*q(1-2+0,ny+2+0,indvars(5))/(param_float(9 + 5)**2*qst(1-2+0,ny+2+0,indvarsst(2))**2))
...
!$OMP END DO
 ...
 end subroutine boundarySchemestored_edges_i1_jmax_0_0
