...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_conv_rho_dx_0_nxp2m1m1jk,d1_conv_rho_dx_0_nxp2m1p0jk,d1_conv_rho_dx_0_nxp2m1p1jk &
            ...
            ,d2_conv_nut_dxdx_0_0_nxp2m1m1jk_nxp2m1m1m1jk,d2_conv_nut_dxdx_0_0_nxp2m1m1jk_nxp2m1m1p0jk,d2_conv_nut_dxdx_0_0_nxp2m1m1jk_nxp2m1m1p1jk &
            ,d2_conv_nut_dxdx_0_0_nxp2m1m1jk &
            ,d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1p0jk,d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1m1jk,d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1m2jk &
            ,d2_conv_nut_dxdx_0_0_nxp2m1p1jk &
            ,d1_conv_nut_dx_0_nxp2m1m1jk,d1_conv_nut_dx_0_nxp2m1p0jk,d1_conv_nut_dx_0_nxp2m1p1jk &
            ,d1_conv_nut_dx_0_nxp2m1jk &
            ,d2_conv_nut_dydy_0_0_nxp2m1jm1k_nxp2m1jm1m1k,d2_conv_nut_dydy_0_0_nxp2m1jm1k_nxp2m1jm1p0k,d2_conv_nut_dydy_0_0_nxp2m1jm1k_nxp2m1jm1p1k &
            ,d2_conv_nut_dydy_0_0_nxp2m1jm1k &
            ,d2_conv_nut_dydy_0_0_nxp2m1jp1k_nxp2m1jp1m1k,d2_conv_nut_dydy_0_0_nxp2m1jp1k_nxp2m1jp1p0k,d2_conv_nut_dydy_0_0_nxp2m1jp1k_nxp2m1jp1p1k &
            ,d2_conv_nut_dydy_0_0_nxp2m1jp1k &
...
d2_conv_nut_dxdx_0_0_nxp2m1m1jk_nxp2m1m1m1jk = q(nx+2-1-1-1,j,indvars(5))

d2_conv_nut_dxdx_0_0_nxp2m1m1jk_nxp2m1m1p1jk = q(nx+2-1-1+1,j,indvars(5))

d2_conv_nut_dxdx_0_0_nxp2m1m1jk = -&
          0.5_wp*d2_conv_nut_dxdx_0_0_nxp2m1m1jk_nxp2m1m1m1jk+&
          0.5_wp*d2_conv_nut_dxdx_0_0_nxp2m1m1jk_nxp2m1m1p1jk

d2_conv_nut_dxdx_0_0_nxp2m1m1jk = d2_conv_nut_dxdx_0_0_nxp2m1m1jk*param_float(1)

d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1p0jk = q(nx+2-1+1+0,j,indvars(5))

d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1m1jk = q(nx+2-1+1-1,j,indvars(5))

d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1m2jk = q(nx+2-1+1-2,j,indvars(5))

d2_conv_nut_dxdx_0_0_nxp2m1p1jk = 1.5_wp*d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1p0jk-&
          2.0_wp*d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1m1jk+&
          0.5_wp*d2_conv_nut_dxdx_0_0_nxp2m1p1jk_nxp2m1p1m2jk

d2_conv_nut_dxdx_0_0_nxp2m1p1jk = d2_conv_nut_dxdx_0_0_nxp2m1p1jk*param_float(1)
...
d1_conv_nut_dx_0_nxp2m1m1jk = q(nx+2-1-1,j,indvars(1))*q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)**1.5)*(1+&
                    ((q(nx+2-1-1,j,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1-1,j,indvars(1)))**3/((q(nx+2-1-1,j,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1-1,j,indvars(1)))**3+&
                    param_float(13 + 5)**3))*(q(nx+2-1-1,j,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1-1,j,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+2-1-1,j,indvarsst(10))*(d2_conv_nut_dxdx_0_0_nxp2m1m1jk)
...
d1_conv_nut_dx_0_nxp2m1p1jk = q(nx+2-1+1,j,indvars(1))*q(nx+2-1+1,j,indvars(2))*q(nx+2-1+1,j,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(nx+2-1+1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1+1,j,indvars(2))*q(nx+2-1+1,j,indvars(2))+&
                    q(nx+2-1+1,j,indvars(3))*q(nx+2-1+1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1+1,j,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+2-1+1,j,indvarsst(10))*(d2_conv_nut_dxdx_0_0_nxp2m1p1jk)
...
d2_conv_nut_dydy_0_0_nxp2m1jm1k_nxp2m1jm1m1k = q(nx+2-1,j-1-1,indvars(5))

d2_conv_nut_dydy_0_0_nxp2m1jm1k_nxp2m1jm1p1k = q(nx+2-1,j-1+1,indvars(5))

d2_conv_nut_dydy_0_0_nxp2m1jm1k = -&
          0.5_wp*d2_conv_nut_dydy_0_0_nxp2m1jm1k_nxp2m1jm1m1k+&
          0.5_wp*d2_conv_nut_dydy_0_0_nxp2m1jm1k_nxp2m1jm1p1k

d2_conv_nut_dydy_0_0_nxp2m1jm1k = d2_conv_nut_dydy_0_0_nxp2m1jm1k*param_float(2)

d2_conv_nut_dydy_0_0_nxp2m1jp1k_nxp2m1jp1m1k = q(nx+2-1,j+1-1,indvars(5))

d2_conv_nut_dydy_0_0_nxp2m1jp1k_nxp2m1jp1p1k = q(nx+2-1,j+1+1,indvars(5))

d2_conv_nut_dydy_0_0_nxp2m1jp1k = -&
          0.5_wp*d2_conv_nut_dydy_0_0_nxp2m1jp1k_nxp2m1jp1m1k+&
          0.5_wp*d2_conv_nut_dydy_0_0_nxp2m1jp1k_nxp2m1jp1p1k

d2_conv_nut_dydy_0_0_nxp2m1jp1k = d2_conv_nut_dydy_0_0_nxp2m1jp1k*param_float(2)
...
d1_conv_nut_dy_0_nxp2m1jm1k = q(nx+2-1,j-1,indvars(1))*q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)**1.5)*(1+&
                    ((q(nx+2-1,j-1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j-1,indvars(1)))**3/((q(nx+2-1,j-1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j-1,indvars(1)))**3+&
                    param_float(13 + 5)**3))*(q(nx+2-1,j-1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j-1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+2-1,j-1,indvarsst(11))*(d2_conv_nut_dydy_0_0_nxp2m1jm1k)
...
d1_conv_nut_dy_0_nxp2m1jp1k = q(nx+2-1,j+1,indvars(1))*q(nx+2-1,j+1,indvars(3))*q(nx+2-1,j+1,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(nx+2-1,j+1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j+1,indvars(2))*q(nx+2-1,j+1,indvars(2))+&
                    q(nx+2-1,j+1,indvars(3))*q(nx+2-1,j+1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j+1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+2-1,j+1,indvarsst(11))*(d2_conv_nut_dydy_0_0_nxp2m1jp1k)
...
d1_dif_rhou_dx_0_nxp2m1m1jk = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1-1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2-1-1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp2m1m1jk)-&
...
d1_dif_rhou_dx_0_nxp2m1p1jk = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2-1+1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1+1,j,indvars(2))*q(nx+2-1+1,j,indvars(2))+&
                    q(nx+2-1+1,j,indvars(3))*q(nx+2-1+1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1+1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2-1+1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp2m1p1jk)-&
...
d1_dif_rhou_dy_0_nxp2m1jm1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j-1,indvars(1))))*param_float(1 + 5)*(qst(nx+2-1,j-1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp2m1jm1k)+&
...
d1_dif_rhou_dy_0_nxp2m1jp1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2-1,j+1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j+1,indvars(2))*q(nx+2-1,j+1,indvars(2))+&
                    q(nx+2-1,j+1,indvars(3))*q(nx+2-1,j+1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j+1,indvars(1))))*param_float(1 + 5)*(qst(nx+2-1,j+1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp2m1jp1k)+&
...
d1_dif_rhov_dx_0_nxp2m1m1jk = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2-1-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1-1,j,indvars(2))*q(nx+2-1-1,j,indvars(2))+&
                    q(nx+2-1-1,j,indvars(3))*q(nx+2-1-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1-1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2-1-1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp2m1m1jk)+&
...
d1_dif_rhov_dx_0_nxp2m1p1jk = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2-1+1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1+1,j,indvars(2))*q(nx+2-1+1,j,indvars(2))+&
                    q(nx+2-1+1,j,indvars(3))*q(nx+2-1+1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1+1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2-1+1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp2m1p1jk)+&
...
d1_dif_rhov_dy_0_nxp2m1jm1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2-1,j-1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j-1,indvars(2))*q(nx+2-1,j-1,indvars(2))+&
                    q(nx+2-1,j-1,indvars(3))*q(nx+2-1,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2-1,j-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp2m1jm1k)-&
...
d1_dif_rhov_dy_0_nxp2m1jp1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(nx+2-1,j+1,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j+1,indvars(2))*q(nx+2-1,j+1,indvars(2))+&
                    q(nx+2-1,j+1,indvars(3))*q(nx+2-1,j+1,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2-1,j+1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp2m1jp1k)-&
...
d1_dif_nut_dx_0_nxp2m1m1jk = q(nx+2-1-1,j,indvars(1))*q(nx+2-1-1,j,indvars(5))

d1_dif_nut_dx_0_nxp2m1p1jk = q(nx+2-1+1,j,indvars(1))*q(nx+2-1+1,j,indvars(5))
...
d1_dif_nut_dx_1_nxp2m1m1jk = q(nx+2-1-1,j,indvars(5))

d1_dif_nut_dx_1_nxp2m1p1jk = q(nx+2-1+1,j,indvars(5))
...
d1_dif_nut_dy_0_nxp2m1jm1k = q(nx+2-1,j-1,indvars(1))*q(nx+2-1,j-1,indvars(5))

d1_dif_nut_dy_0_nxp2m1jp1k = q(nx+2-1,j+1,indvars(1))*q(nx+2-1,j+1,indvars(5))
...
d1_dif_nut_dy_1_nxp2m1jm1k = q(nx+2-1,j-1,indvars(5))

d1_dif_nut_dy_1_nxp2m1jp1k = q(nx+2-1,j+1,indvars(5))
...
rhs(nx+2-1,j,indvars(5)) = rhs(nx+2-1,j,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(nx+2-1,j,indvarsst(10)))**2*(d1_dif_nut_dx_0_nxp2m1jk)*(d1_dif_nut_dx_1_nxp2m1jk)+&
                    (qst(nx+2-1,j,indvarsst(11)))**2*(d1_dif_nut_dy_0_nxp2m1jk)*(d1_dif_nut_dy_1_nxp2m1jk))-&
                    param_float(6 + 5)*(1-&
                    ...
                    param_float(21 + 5))*((q(nx+2-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j,indvars(2))*q(nx+2-1,j,indvars(2))+&
                    q(nx+2-1,j,indvars(3))*q(nx+2-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j,indvars(1)))**2)))*(qst(nx+2-1,j,indvarsst(4))+&
                    param_float(1 + 5)*q(nx+2-1,j,indvars(5))/(param_float(9 + 5)**2*qst(nx+2-1,j,indvarsst(2))**2))*q(nx+2-1,j,indvars(1))*q(nx+2-1,j,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*qst(nx+2-1,j,indvarsst(13))-&
                    ...
                    param_float(21 + 5))*((q(nx+2-1,j,indvars(4))-&
                    0.5_wp*(q(nx+2-1,j,indvars(2))*q(nx+2-1,j,indvars(2))+&
                    q(nx+2-1,j,indvars(3))*q(nx+2-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(nx+2-1,j,indvars(1)))**2)))*q(nx+2-1,j,indvars(1))*q(nx+2-1,j,indvars(5))**2/qst(nx+2-1,j,indvarsst(1))**2 ) 
