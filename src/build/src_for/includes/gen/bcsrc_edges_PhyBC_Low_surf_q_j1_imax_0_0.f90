...
subroutine boundaryScheme_edges_PhyBC_Low_surf_q_j1_imax_0_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
q(nx+2+0,1-2+0,indvars(3)) =  0.0_wp
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_PhyBC_Low_surf_q_j1_imax_0_0
