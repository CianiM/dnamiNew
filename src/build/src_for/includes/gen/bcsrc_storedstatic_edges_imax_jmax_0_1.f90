...
subroutine boundarySchemestoredstatic_edges_imax_jmax_0_1(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_nxp2p0p0nyp2m1k,d1_stemp_dx_0_nxp2p0m1nyp2m1k,d1_stemp_dx_0_nxp2p0m2nyp2m1k &
            ...
            ,d1_detady_dy_0_nxp2p0nyp2m1m1k,d1_detady_dy_0_nxp2p0nyp2m1p0k,d1_detady_dy_0_nxp2p0nyp2m1p1k &
            ,d1_detady_dy_0_nxp2p0nyp2m1k &
            ,d1_dksidy_dy_0_nxp2p0nyp2m1m1k,d1_dksidy_dy_0_nxp2p0nyp2m1p0k,d1_dksidy_dy_0_nxp2p0nyp2m1p1k &
            ,d1_dksidy_dy_0_nxp2p0nyp2m1k &
            ,d1_detadx_dx_0_nxp2p0p0nyp2m1k,d1_detadx_dx_0_nxp2p0m1nyp2m1k,d1_detadx_dx_0_nxp2p0m2nyp2m1k &
            ,d1_detadx_dx_0_nxp2p0nyp2m1k &
            ,d1_dksidx_dx_0_nxp2p0p0nyp2m1k,d1_dksidx_dx_0_nxp2p0m1nyp2m1k,d1_dksidx_dx_0_nxp2p0m2nyp2m1k &
            ,d1_dksidx_dx_0_nxp2p0nyp2m1k 
...
qst(nx+2+0,ny+2-1,indvarsst(14)) =  (q(nx+2+0,ny+2-1,indvars(5))/((qst(nx+2+0,ny+2-1,indvarsst(4))+&
...
!$OMP END DO
 ...
 end subroutine boundarySchemestoredstatic_edges_imax_jmax_0_1
