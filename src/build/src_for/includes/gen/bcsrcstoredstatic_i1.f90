...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_detady_dy_0_1m2p0jm1k,d1_detady_dy_0_1m2p0jp0k,d1_detady_dy_0_1m2p0jp1k &
 ...
 real(wp) ::  d1_detady_dy_0_1m2p1jm1k,d1_detady_dy_0_1m2p1jp0k,d1_detady_dy_0_1m2p1jp1k &
...
!***********************************************************
!                                                           
! building source terms in RHS for layer 0 None None wall **
!                                                           
!***********************************************************
...
!***********************************************************
!                                                           
! Update BC terms for layer 0 None None wall ***************
!                                                           
!***********************************************************


qst(1-2+0,j,indvarsst(19)) =  dabs(1-&
                    qst(1-2+0,j,indvarsst(5)))
...
!***********************************************************
!                                                           
! building source terms in RHS for layer 1 None None wall **
!                                                           
!***********************************************************
...
!***********************************************************
!                                                           
! Update BC terms for layer 1 None None wall ***************
!                                                           
!***********************************************************


qst(1-2+1,j,indvarsst(19)) =  dabs(1-&
                    qst(1-2+1,j,indvarsst(5)))
