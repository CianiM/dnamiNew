...
subroutine boundarySchemestoredstatic_edges_imax_jmax_1_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_nxp2m1m1nyp2p0k,d1_stemp_dx_0_nxp2m1p0nyp2p0k,d1_stemp_dx_0_nxp2m1p1nyp2p0k &
            ...
            ,d1_detady_dy_0_nxp2m1nyp2p0p0k,d1_detady_dy_0_nxp2m1nyp2p0m1k,d1_detady_dy_0_nxp2m1nyp2p0m2k &
            ,d1_detady_dy_0_nxp2m1nyp2p0k &
            ,d1_dksidy_dy_0_nxp2m1nyp2p0p0k,d1_dksidy_dy_0_nxp2m1nyp2p0m1k,d1_dksidy_dy_0_nxp2m1nyp2p0m2k &
            ,d1_dksidy_dy_0_nxp2m1nyp2p0k &
            ,d1_detadx_dx_0_nxp2m1m1nyp2p0k,d1_detadx_dx_0_nxp2m1p0nyp2p0k,d1_detadx_dx_0_nxp2m1p1nyp2p0k &
            ,d1_detadx_dx_0_nxp2m1nyp2p0k &
            ,d1_dksidx_dx_0_nxp2m1m1nyp2p0k,d1_dksidx_dx_0_nxp2m1p0nyp2p0k,d1_dksidx_dx_0_nxp2m1p1nyp2p0k &
...
qst(nx+2-1,ny+2+0,indvarsst(14)) =  (q(nx+2-1,ny+2+0,indvars(5))/((qst(nx+2-1,ny+2+0,indvarsst(4))+&
...
!$OMP END DO
 ...
 end subroutine boundarySchemestoredstatic_edges_imax_jmax_1_0
