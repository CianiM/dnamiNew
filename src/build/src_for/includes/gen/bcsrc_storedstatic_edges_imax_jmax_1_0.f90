...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_detady_dy_0_nxp2m1nyp2p0p0k,d1_detady_dy_0_nxp2m1nyp2p0m1k,d1_detady_dy_0_nxp2m1nyp2p0m2k &
...
qst(nx+2-1,ny+2+0,indvarsst(19)) =  dabs(1-&
                    qst(nx+2-1,ny+2+0,indvarsst(5)))
